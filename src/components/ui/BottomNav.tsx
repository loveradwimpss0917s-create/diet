...
export function BottomNav() {
  ...
  return (
    <nav className="shrink-0 border-t border-zinc-200 bg-white/95 backdrop-blur [padding-bottom:env(safe-area-inset-bottom)] dark:border-zinc-800 dark:bg-zinc-900/95">
