    ...
    .upsert(
      {
        ...
        bmi: log.bmi ?? null,
        visceral_fat_level: log.visceral_fat_level ?? null,
        basal_metabolism_kcal:
          log.basal_metabolism_kcal !== undefined ? Math.round(log.basal_metabolism_kcal) : null,
        body_age: log.body_age !== undefined ? Math.round(log.body_age) : null,
        bone_mass_kg: log.bone_mass_kg ?? null,
        muscle_quality_score: log.muscle_quality_score ?? null,
        body_water_percent: log.body_water_percent ?? null,
